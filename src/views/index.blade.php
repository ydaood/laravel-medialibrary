  ...
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        <h1 class="panel-title">{{env('APP_NAME')}} FileManager</h1>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10 col-xs-12" id="main">
        ...
        <div id="content"></div>
       @if(!request('mode')) <button id="chooseItems" class="btn btn-success" >choose</button>@endif
      </div>
